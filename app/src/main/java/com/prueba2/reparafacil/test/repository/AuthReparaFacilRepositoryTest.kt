package com.prueba2.reparafacil.test.repository
...
class AuthSaborLocalRepositoryTest {
    ...
    fun setup() {
        ...
        mockkObject(com.prueba2.reparafacil.data.remote.RetrofitClient)
        every { com.prueba2.reparafacil.data.remote.ApiService } returns mockApiService
